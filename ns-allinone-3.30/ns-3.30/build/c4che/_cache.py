...
CFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEMBED = ['-g', '-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3']
CXXFLAGS_PYEXT = ['-g', '-fdebug-prefix-map=/build/python3.6-0aiVHW/python3.6-3.6.9=.', '-fstack-protector', '-g', '-fwrapv', '-O3', '-fvisibility=hidden', '-Wno-array-bounds']
...
EXAMPLE_DIRECTORIES = ['routing', 'traffic-control', 'stats', 'naming', 'ipv6', 'realtime', 'udp-client-server', 'tutorial', 'error-model', 'socket', 'energy', 'matrix-topology', 'udp', 'tcp', 'wireless']
...
NS3_EXECUTABLE_PATH = ['/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/ns-3.30/build/src/fd-net-device', '/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/ns-3.30/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/7', '/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/ns-3.30/build/lib']
...
VALGRIND_FOUND = True
VERSION = '3.30'
WITH_PYBINDGEN = '/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/pybindgen-0.20.0'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/ns-3.30/build/ns3/config-store-config.h', '/home/kaus/Desktop/NS3_exp/ns-allinone-3.30/ns-3.30/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
