...
PyObject *
PyNs3OutdoorPositionAllocator__PythonHelper::_wrap_NotifyNewAggregate(PyNs3OutdoorPositionAllocator *self)
{
    PyObject *py_retval;
    PyNs3OutdoorPositionAllocator__PythonHelper *helper = dynamic_cast< PyNs3OutdoorPositionAllocator__PythonHelper* >(self->obj);
...
PyObject *
_wrap_PyNs3OutdoorPositionAllocator_GetNext(PyNs3OutdoorPositionAllocator *self)
{
    PyObject *py_retval;
    PyNs3OutdoorPositionAllocator__PythonHelper *helper_class = dynamic_cast<PyNs3OutdoorPositionAllocator__PythonHelper*> (self->obj);
    PyNs3Vector3D *py_Vector3D;
...
PyObject *
_wrap_PyNs3OutdoorPositionAllocator_GetTypeId(void)
{
    PyObject *py_retval;
    PyNs3TypeId *py_TypeId;
...
static PyObject*
_wrap_PyNs3OutdoorPositionAllocator__copy__(PyNs3OutdoorPositionAllocator *self)
{
