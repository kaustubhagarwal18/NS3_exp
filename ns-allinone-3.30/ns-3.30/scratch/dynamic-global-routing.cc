...
main (int argc, char *argv[])
{
  ...
  NetDeviceContainer d5d6 = p2p.Install (n5n6);                      // 1500, 10 
  ...
  Simulator::Schedule (Seconds (2),&Ipv4::SetDown,ipv41, ipv4ifIndex1);        // n1 -- n6 down
  Simulator::Schedule (Seconds (4),&Ipv4::SetUp,ipv41, ipv4ifIndex1);          // n1 -- n6 up
  ...
  Simulator::Schedule (Seconds (6),&Ipv4::SetDown,ipv46, ipv4ifIndex6);        // n6 --- n1 down
